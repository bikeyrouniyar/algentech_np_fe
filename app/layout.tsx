    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          ...
          content="Turn ideas into world-class software with AI-powered development. Prototypes ready in 90 hours."
        />
        ...
        <meta
          name="description"
          content="ALGENTECH is a leading software and AI company in Nepal, offering AI consulting, custom software development, and digital transformation services."
        />
        <script
